...
def main():
    folder1 = "path/to/reference/folder"
    folder2 = "path/to/comparison/folder"
...
if __name__ == "__main__":
    folder1 = "path/to/reference/folder1"
    folder2 = "path/to/comparison/folder3"
    output_folder = "path/to/output/folder1vs3"
